...
public final class ReflectionUtility {
	 ...
	 * Note:
	 * <p/>
	 * 1)this method assume that given class is parameterized subclass(interface)
	 * and parent class is not {@link Object} so may cause
	 * {@link NullPointerException} at runtime.
	 * <p/>
	 * 2)this method assume that genericSuperClass is ParameterizedType and even
	 * does not validate it so may produce {@link ClassCastException} at runtime.
	 * <p/>
	 ...
	 * <p/>
	 * For example method
	 * <code>void foo(java.land.String s, com.katesoft.jvmcluster.persistent.User)</code>
	 * will have signature like this <code>foo(String, User)</code>.
	 * 
