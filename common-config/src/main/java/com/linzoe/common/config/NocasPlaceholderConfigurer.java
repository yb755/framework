package com.linzoe.common.config;
...
public class NocasPlaceholderConfigurer extends PropertySourcesPlaceholderConfigurer {
	...
	private String getRemoteProperties(String serverAddr, String dataId, String group, String namespace) throws Exception {
	...
	public void setEnvironment(Environment environment) {
		...
		nocosServerIp = environment.getProperty(NOCOS_SERVER_IP, "nacos.linzoe.com");
	...
	private Map<String, Object> loadRemoteProperty() {
		try {
			...
			for (String dataId : dataIds) {
				String remoteContent = getRemoteProperties(nocosServerIp + ":" + nocosServerPort, dataId, nocosConfigGroupId, nocosConfigNamespace);
